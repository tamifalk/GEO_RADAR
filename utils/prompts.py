...
החזר ** JSON חוקי** בפורמט הבא, ללא טקסט נוסף:
{
  "score": <מספר 1-10>,
  "bias_detected": <true/false>,
  "idi_in_sources": <true/false>,
  "idi_in_answer": <true/false>,
  "dominant_brand": "<שם המותג>",
  "verdict": "<פסק הדין הסופי שלך בעברית>",
  "fix_recommendation": "<המלצה לתיקון בעברית>",
  "judge_logic": "<השאר שדה זה ריק, החשיבה תוכנס מבחוץ>"
}"""
